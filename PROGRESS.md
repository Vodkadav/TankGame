...
- [~] M3 / ADR-0019 — networked multiplayer, host-authoritative relay (step 1 relay DO + step 2 Host/Join lobby UX done; next: step 3 host authority loop + 3D net scene, then protocol fidelity + two-device playtest)
