...
- [~] Parallel batch 2026-07-17 (orchestrated; three branches pushed, NONE merged — owner gates below):
  **SFX overhaul** (`feat/sfx-overhaul` @ d55195b) — the 12 silenced placeholder sounds (tank-death
  ...
  **Net victory screen** (`feat/net-victory-screen` @ 8c57885) — victory screen v2 on BOTH host and
  ...
  **Net teleport pads** (`feat/net-teleport-pads` @ 6ef28e7, based ON the victory-screen branch —
  merge together or S2-then-S3) — Cliffs' cross-layer pads now work online: host tanks got the
