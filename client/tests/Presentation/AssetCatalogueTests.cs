...
public class AssetCatalogueTests : TestClass
{
    ...
    public void Active_CanSwapASingleAsset_WithoutTouchingTheRest()
    {
        ...
        try
        {
            AssetCatalogue.Active = original with { Bullet = "res://src/Presentation/Projectile/Bullet.png" };

            if (AssetCatalogue.Active.Bullet != "res://src/Presentation/Projectile/Bullet.png")
            {
